...
@Autonomous(name="Preload Only Blue", group = "Autonomous")
public class PreBlue extends LinearOpMode {

    private final Pose start = new Pose(60, 8, Math.toRadians(270));

    private final Pose farShooting = new Pose(60, 13, Math.toRadians(294));
    private final Pose farShooting2 = new Pose(60, 13, Math.toRadians(295.5));
    ...
    private final double FAR_SHOOTING_VELOCITY = 330;
    ...
    public void runOpMode() {
        ...
        // Park
        followTwoPointPath(farShooting, park, 3);
